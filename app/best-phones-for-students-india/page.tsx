...
export default async function BestPhonesForStudentsPage() {
  const { month, year } = currentMonthYear()
  const articles = await getPillarArticles(['student', 'college', 'budget', 'lightweight', 'battery', 'affordable', 'first phone', 'school'], [], 15)
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="bg-white border border-border p-4">
                <p className="font-sans text-xs font-bold text-ink mb-1">Battery life first</p>
                <p className="font-sans text-xs text-muted leading-relaxed">Long college days with streaming, navigation, and social media drain batteries fast. 5000mAh is the minimum for all-day use.</p>
              </div>
              <div className="bg-white border border-border p-4">
                <p className="font-sans text-xs font-bold text-ink mb-1">Durable build for daily carry</p>
                <p className="font-sans text-xs text-muted leading-relaxed">Gorilla Glass front and decent back panel. Students drop phones. IP53 or IP68 rating helps during monsoon commutes.</p>
              </div>
              <div className="bg-white border border-border p-4">
                <p className="font-sans text-xs font-bold text-ink mb-1">Camera for documents and class</p>
                <p className="font-sans text-xs text-muted leading-relaxed">Board photos, assignment scanning, and group photos. A 50MP main camera handles all of this reliably.</p>
              </div>
              <div className="bg-white border border-border p-4">
                <p className="font-sans text-xs font-bold text-ink mb-1">Software updates for college duration</p>
                <p className="font-sans text-xs text-muted leading-relaxed">Buy a phone that gets security updates for your entire 3-4 year college duration. Samsung is the safest bet here.</p>
              </div>
            </div>
          </section>
