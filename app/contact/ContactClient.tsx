      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div>
          ...
          <div className="space-y-4">
            {[
              { label: 'Editorial', value: 'editorial@thetechbharat.com', icon: '✉' },
              { label: 'Press & PR', value: 'press@thetechbharat.com', icon: '📰' },
              { label: 'Advertising', value: 'ads@thetechbharat.com', icon: '📊' },
              { label: 'Corrections', value: 'corrections@thetechbharat.com', icon: '✏️' },
            ].map(item => (
