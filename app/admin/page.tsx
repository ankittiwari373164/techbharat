                      ...
                      <div key={slide.id} className="border border-gray-200 rounded-xl p-4 bg-gray-50">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div>
                            ...
                            <input type="text" value={slide.ctaLink||''} onChange={e=>updateSlide(i,'ctaLink',e.target.value)} placeholder="/samsung-s25-review" className="w-full text-xs border border-gray-200 px-2.5 py-2 rounded-lg outline-none bg-white"/>
                          </div>
                        </div>
                        {/* Slide preview */}
                        {slide.imageUrl && (
